         ...
         if ($this->form_validation->run()) {
          ...
          for ($i=0; $i < $qty_produto; $i++) { 
           ...
           $this->core_model->insert('venda_produtos', $data);
                     ...
                     //inicio de atualização de estoque
        ...
        // $venda_produtos = $data['venda_produtos'] = $this->vendas_model->get_all_produtos_by_venda($venda_id);  
         ...
         if ($this->form_validation->run()) {
          ...
          $this->core_model->update('vendas', $data, array('venda_id'=> $venda_id));
                   //Deletando da venda, os produto antigos da venda editada
         ...
         //  foreach ($venda_produtos as $venda_p) {
             ...
             //}
            //}
           //fim de atualização de estoque 
             
              }//fim foreach

                   //criar recusos pdf
                  // redirect('vendas/mprimir/'. $venda_id);
                   redirect('vendas');
   ...
   public function imprimir($venda_id = NULL)
         ...
         public function pdf($venda_id = NULL)
      {
        ...
        //exit();
         ...
         $html .='<title>'.$empresa->sistema_nome_fantasia.'| Impressão de ordem de Venda</title>';
         ...
         $html .='</head>';
          ...
          $html .='<h4 align="center">
               ...
               $html.='<p align="right" style = "font-sizer: 12px">O.S N&nbsp;'.$venda->venda_id.'</p>';
