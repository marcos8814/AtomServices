        ...
        <?php endif; ?>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">           <!-- o codigo em php abaixo carrega ação do btn -->
              <a title="Cadastrar nova forma de pagamento"href="<?php echo base_url('pagamento/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus"></i></i>&nbsp;Nova</a>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered dataTable"  width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Nome da forma de pagemento</th>
                      <th class="text-center">Aceita parcelamentos</th>
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center pr-4"> <?php echo ($forma->forma_pagamento_aceita_parc == 1 ? '<span class="badge badge-info btn-sm">Sim</span>' : '<span class="badge badge-danger btn-sm">Não</span>') ?>
                      ...
                      <td class="text-center pr-4"> <?php echo ($forma->forma_pagamento_ativa == 1 ? '<span class="badge badge-info btn-sm">Sim</span>' : '<span class="badge badge-danger btn-sm">Não</span>') ?>

                                            </td>
                      <td class="text-right">
                        
                        <a title="Editar" href="<?php echo base_url('pagamento/edit/'.$forma->forma_pagamento_id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Tem certeza que deseja excluir este forma?</h5>
