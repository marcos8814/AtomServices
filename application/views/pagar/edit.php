...
<div id="content">
 ...
 <div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="col-md-3"> 
     ...
     <input type="text" class="form-control form-control-user" name="produto_unidade" placeholder="Unidade do produto" value="<?php echo $produto->produto_unidade; ?>"> <!--last_name é o sobrenome do campo da tabela que esta no banco de dados  -->
 ...
 <div class="form-group row mb-3"> 
   ...
   <div class="col-md-2"> 
    ...
    <div class="col-md-10"> 
       <label>Descrição do produto*</label>
       <textarea class="form-control form-control-user " name="produto_obs"><?php echo $produto->produto_obs; ?></textarea> <!--email é o nome do campo da tabela que esta no banco de dados  -->
