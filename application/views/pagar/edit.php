  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
     ...
     <form class="user" method="POST" name="form_edit"> <!--metodo post reponsavel por proteger campo da url -->
      <p><strong><i class="fas fa-tools"></i>&nbsp;&nbsp;Útima Alteração: </strong><?php echo formata_data_banco_com_hora( $conta_pagar->conta_pagar_data_alteracao);?></p>:
     ...
     <input type="date" class="form-control form-control-user-date" name="conta_pagar_data_vencimento"  value="<?php echo $conta_pagar->conta_pagar_data_vencimento; ?>"> <!--last_name é o sobrenome do campo da tabela que esta no banco de dados  -->
    ...
    <div class="col-md-2"> 
     ...
     <input type="text" class="form-control form-control-user-date money2" name="conta_pagar_valor"  value="<?php echo $conta_pagar->conta_pagar_valor; ?>"> <!--last_name é o sobrenome do campo da tabela que esta no banco de dados  -->
   ...
   <div class="col-md-2"> 
    ...
    <div class="col-md-12"> 
       ...
       <textarea class="form-control " name="conta_pagar_obs"><?php echo $conta_pagar->conta_pagar_obs; ?></textarea> <!--email é o nome do campo da tabela que esta no banco de dados  -->
