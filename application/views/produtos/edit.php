       ...
       <div class="form-group row mb-3"> <!--altera o tamanho do campo nome  -->
         ...
         <div class="col-md-4 mb-3 "> 
           ...
           <select class="custom-select" name="produto_marca_id">
              ...
              <option title="<?php echo($marca->marca_ativa == 0 ? 'O campo esta inativo' : 'Marca ativa') ?>" value="<?php echo $marca->marca_id ?>"<?php echo ($marca->marca_id == $produto->produto_marca_id ? 'selected' : '' ) ?><?php echo ($marca->marca_ativa == 0 ? 'disabled' : '')  ?>><?php echo ($marca->marca_ativa == 0 ? $marca->marca_nome .'&nbsp;->&nbsp;Inativa':$marca->marca_nome) ?></option>
            <?php endforeach; ?>
           </select>
         </div>
         ...
         <div class="col-md-4 mb-3 "> 
          ...
          <div class="col-md-4 mb-3 "> 
           ...
           <select class="custom-select" name="produto_fornecedor_id">
              ...
              <option title="<?php echo($fornecedor->fornecedor_ativo == 0 ? 'O campo esta inativo' : 'Fornecedor ativo') ?>" value="<?php echo $fornecedor->fornecedor_id ?>"<?php echo ($fornecedor->fornecedor_id == $produto->produto_fornecedor_id ? 'selected' : '' ) ?><?php echo ($fornecedor->fornecedor_ativo == 0 ? 'disabled' : '')  ?>><?php echo ($fornecedor->fornecedor_ativo == 0 ? $fornecedor->fornecedor_nome_fantasia .'&nbsp;->&nbsp;Inativo':$fornecedor->fornecedor_nome_fantasia) ?></option>
            <?php endforeach; ?>
           </select>
         </div>
