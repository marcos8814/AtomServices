        ...
        <?php endif; ?>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">           <!-- o codigo em php abaixo carrega ação do btn -->
              <a title="Cadastrar novo produto"href="<?php echo base_url('produtos/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-plus"></i></i>&nbsp;Novo</a>
            </div>
            <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        ...
                        <a title="Editar" href="<?php echo base_url('produtos/edit/'.$produto->produto_id); ?>" class="btn btn-sm btn-primary"><i class="far fa-edit"></i></a>
