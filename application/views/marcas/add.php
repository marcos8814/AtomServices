    ...
    <div class="card-body">
     ...
     <form class="user" method="POST" name="form_add"> <!--metodo post reponsavel por proteger campo da url -->
      ...
      <fieldset class="mt-4 border p-2">          
       ...
       <legend class="font-small"><i class="fas fa-tools"></i>&nbsp;Dados do marca</legend>


       <div class="form-group row"> <!--altera o tamanho do campo nome  -->
         <div class="col-md-5"> 
           <label>Marca*</label>
           <input type="text" class="form-control form-control-user" name="marca_nome" placeholder="Tipo de serviço " value="<?php echo set_value ('marca_nome'); ?>"> <!--first_name é o nome do campo da tabela que esta no banco de dados  -->
